    ...
    <header className={`fixed w-full bg-white z-50 transition-all duration-300 ${scrolled ? 'bg-opacity-95 shadow-sm' : 'bg-opacity-90'}`}>
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        >
          ...
          <Link href="/blog">
            <a className="text-neutral-dark hover:text-primary transition duration-300 cursor-pointer">Blog</a>
          </Link>
        </motion.nav>
      ...
      >
        ...
        <Link href="/blog">
          <a className="block py-2 text-neutral-dark hover:text-primary" onClick={toggleMobileMenu}>Blog</a>
        </Link>
